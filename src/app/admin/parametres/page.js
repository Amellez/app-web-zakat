...
export default function ParametresPage() {
  ...
  // Gérer le changement de répartition
  ...
  // Gérer le changement de coefficients
  ...
  const handleSave = async () => {
    ...
    try {
      await updateParametres(parametres, user?.email);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 to-teal-100 py-8">
      ...
      {/* Style pour l'animation du popup */}
      <style jsx>{`
