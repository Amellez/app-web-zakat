...
export default function ModalAssignerBenevole({ isOpen, onClose, itineraire, mosqueeId, onSuccess }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await assignerItineraireBenevole(itineraire.id, formData, mosqueeId);
